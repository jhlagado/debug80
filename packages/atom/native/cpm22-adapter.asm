...
OR   A
LD   A,16
JR   NZ,CP_HEX_SIZE_READY
LD   A,L
CP   16
JR   C,CP_HEX_SIZE_READY
LD   A,16
CP_HEX_SIZE_READY:
LD   (CP_HEX_SIZE),A
LD   (CP_HEX_DATA_LEFT),A
LD   A,':'
CALL CP_HEX_PUT
XOR  A
LD   (CP_HEX_SUM),A
...
CALL CP_HEX_FIELD
CP_HEX_DATA:
LD   A,(CP_HEX_DATA_LEFT)
OR   A
JR   Z,CP_HEX_CHECKSUM
LD   HL,(CP_OUTPUT_CURSOR)
LD   A,(HL)
INC  HL
LD   (CP_OUTPUT_CURSOR),HL
...
CP_HEX_EOF_TEXT: DB ':','0','0','0','0','0','0','0','1','F','F',13,10
