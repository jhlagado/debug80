...
This is distinct from Rule 1's simple negation pair. Rule 1 is "X is not Y; it is Z" — a definitional negation. False uplift is "X is not _just_ Y — it is something _more_." The "more" never materialises.
