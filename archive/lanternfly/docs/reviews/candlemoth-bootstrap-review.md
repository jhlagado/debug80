...
> **Superseded in part.** This review's findings about the three-pass
> architecture were acted on and the architecture has since been withdrawn:
> Lanternfly is single-pass, and `docs/bootstrap-plan.md` and
> `docs/level0-findings.md` finding 19 record why. The review is kept as the
> record of what was asked at the time.
