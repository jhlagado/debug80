...
Lanternfly is retired from active development. This directory preserves its
language documents, compiler experiments, source, tests, and unfinished work at
the point of retirement. It is outside the repository's npm workspaces and does
not participate in the active build or test suite.

Current language and virtual-machine work belongs to
[Nucleus](../../packages/nucleus/README.md). Files below retain their original
terminology and may contain obsolete plans, paths, links, and conclusions. They
are preserved as research material rather than maintained specifications.
