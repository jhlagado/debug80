...
- **CLI contract:** `cli_artifacts`, `pr249_cli_lock_eviction_matrix` (`cli_determinism_contract`, `cli_path_parity_contract` **ported**).
...
10. CLI contract tests (`cli_artifacts`; **cli_determinism_contract**, **cli_path_parity_contract** ported).
