...
- **CLI contract:** **pr249_cli_lock_eviction_matrix** **ported** (`test/cli/pr249-cli-lock-eviction-matrix.test.ts`); **cli_artifacts**, **cli_determinism_contract**, **cli_path_parity_contract**, **cli_source_extension**, **cli_azm_smoke** **ported**. Remaining oracle CLI: `cli_acceptance_matrix_strictness`, `register_care_cli`.
...
10. CLI contract tests (**cli_artifacts**, **pr249_cli_lock_eviction_matrix**, **cli_determinism_contract**, **cli_path_parity_contract**, **cli_source_extension**, **cli_azm_smoke** ported; next: `cli_acceptance_matrix_strictness`, `register_care_cli`).
