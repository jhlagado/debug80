...
This manual is updated against the codebase state through **2026-06-14**. These notes give maintainers a quick view of changes that affect several chapters:
