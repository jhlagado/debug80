...
This manual is updated against the codebase state through **2026-07-02**. These notes give maintainers a quick view of changes that affect several chapters:
