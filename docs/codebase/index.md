...
This manual is updated against the codebase state through **2026-06-21**. These notes give maintainers a quick view of changes that affect several chapters:
