...
export interface GlimmerLaunchOptions {
  /** Assembler used for the Z80 source generated by Glimmer. */
  assembler?: 'atom' | 'azm';
}
...
export interface LaunchRequestArguments extends DebugProtocol.LaunchRequestArguments {
  ...
  /** Glimmer frontend options, including the generated-source assembler. */
