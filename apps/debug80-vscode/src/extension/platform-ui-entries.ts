    ...
    loadUiModules: async (): Promise<PlatformUiModules> => {
      ...
      return {
        ...
        applyUpdate: (uiState, payload): Record<string, unknown> => {
          ...
          return {
            ...serializeTec1gUpdateFromUiState(tec1gState, tec1gPayload.speakerHz),
            ...(tec1gPayload.matrixScanCycles !== undefined
              ? { matrixScanCycles: tec1gPayload.matrixScanCycles }
              : {}),
            ...(tec1gPayload.matrixDroppedScanCycles !== undefined
              ? { matrixDroppedScanCycles: tec1gPayload.matrixDroppedScanCycles }
              : {}),
