...
[Part VII](index.md) | [Custom Commands, UI Panels, and Source Mapping →](17-custom-commands-ui-and-mapping.md)
...
export function createMyplatformIoHandlers(
  ...
  return {
    ...
    ioWrite(port, value) {
      switch (port & 0xff) {
        case 0x01:
          handleDisplayPort(state, value, callbacks);
          break;
      }
    },
  };
