...
and Nucleus programs. It builds your project, runs it inside an integrated Z80 runtime,
...
- **Source-level Z80 debugging**: set breakpoints in `.asm`, `.z80`, and `.nu` files,
...
target selector to add any `.asm`, `.z80`, or `.nu` program in the project.
Sources may live at the project root, under `src/`, or in other
