...
describe('extension activation', () => {
  ...
  it('registers commands and adapter factory', async () => {
    ...
    expect(registerCommand).toHaveBeenCalledWith('debug80.openSourceFile', expect.anything());
    expect(registerCommand).toHaveBeenCalledWith('debug80.showSourceMapStatus', expect.anything());
