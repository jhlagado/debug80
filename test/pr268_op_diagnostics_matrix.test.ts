  ...
  it.each([
    {
      ...
      fixture: 'pr268_op_no_match_diagnostics.asm',
  ...
  it.each([
    {
      ...
      fixture: 'pr268_op_arity_mismatch_diagnostics.asm',
  ...
  it.each([
    {
      ...
      fixture: 'pr267_op_ambiguous_incomparable.asm',
  ...
  it.each([
    {
      ...
      fixture: 'pr270_op_invalid_expansion_diagnostics.asm',
  ...
  it.each([
    {
      ...
      fixture: 'pr270_op_invalid_expansion_nested_chain.asm',
      id: DiagnosticIds.OpInvalidExpansion,
