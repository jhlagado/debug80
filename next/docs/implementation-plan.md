...
- [x] Added a shared unsupported-fixture registry (`next/test/differential/unsupported-fixtures.ts`)
      with explicit root corpus gaps (40 fixtures) and reasons.
...
- [x] Locked the unsupported set contract for root fixtures to require exact file membership and explicit count (40).
...
- Root corpus parity is now evidence-backed for 45 supported root fixtures with an explicit unsupported roster of 40 fixtures.
